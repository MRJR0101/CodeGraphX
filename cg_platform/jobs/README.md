...
```powershell
cd C:\Dev\PROJECTS\00_PyToolbelt\05_CodeAnalysis\codegraphx\codegraphx\platform\jobs
...
| File | Lines | Purpose |
|------|-------|---------|
| `__init__.py` | 9 | Package initializer |
| `queue.py` | 36 | Python script |
| `worker.py` | 41 | Python script |
