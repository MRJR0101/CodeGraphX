...
- Python 3.8+
- Windows 10/11
- Third-party: codegraphx

## Quick Start

```powershell
cd C:\Dev\PROJECTS\00_PyToolbelt\05_CodeAnalysis\codegraphx\codegraphx\platform\storage
...
| File | Lines | Purpose |
|------|-------|---------|
| `__init__.py` | 8 | Package initializer |
| `memory.py` | 32 | Python script |
| `repositories.py` | 22 | Python script |
