...
- Python 3.8+
- Windows 10/11
- Third-party: codegraphx, numpy, sentence_transformers

## Quick Start

```powershell
cd C:\Dev\PROJECTS\00_PyToolbelt\05_CodeAnalysis\codegraphx\codegraphx\semantic
...
| `semantic_layer.py` | 247 | Python script |
