...
```powershell
cd C:\Repository\codegraphx\tests\integration
python test_call_graph_edges.py --help
```

**First run:**
```powershell
python test_call_graph_edges.py --dry-run
```
...
| File | Lines | Purpose |
|------|-------|---------|
| `test_call_graph_edges.py` | 60 | Python script |
| `test_non_db_snapshot_delta_pipeline.py` | 125 | Python script |
| `test_pipeline_golden.py` | 102 | Python script |
