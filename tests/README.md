...
- Python 3.8+
- Windows 10/11
- Third-party: codegraphx, pytest

## Quick Start

```powershell
cd C:\Dev\PROJECTS\00_PyToolbelt\05_CodeAnalysis\codegraphx\codegraphx\tests
...
| File | Lines | Purpose |
|------|-------|---------|
| `__init__.py` | 2 | Package initializer |
| `test_all.py` | 587 | Python script |
| `test_models.py` | 61 | Python script |
| `test_platform_scaffold.py` | 33 | Python script |
